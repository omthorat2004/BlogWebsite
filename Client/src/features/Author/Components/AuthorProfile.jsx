      ...
      <Box bgcolor='white' minHeight='80vh' borderRadius={7} boxShadow='0 0 10px lightgrey'>
        <Box display='flex' bgcolor='white'  padding={{xs:3,md:5}} borderRadius='15px 15px 0 0 ' justifyContent='flex-start' alignItems='center'>
            <Box sx={avatarBoxStyle}>
              <Avatar src='https://wallpapercave.com/wp/wp12944056.jpg' sx={{height:{xs:'35px',md:'65px'},width:{xs:'35px',md:'65px'}}}/>
            </Box>
            <Typography sx={{fontSize:{xs:'18px',md:'25px'},margin:{xs:'0 10px',md:'0 20px'}}} fontWeight={700}>Om Thorat</Typography>
